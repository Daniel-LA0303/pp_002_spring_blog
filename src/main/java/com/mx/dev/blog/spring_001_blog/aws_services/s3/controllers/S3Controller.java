package com.mx.dev.blog.spring_001_blog.aws_services.s3.controllers;
...
public class S3Controller {
	...
	@Autowired
	public S3Controller(S3Service awsService) {
	...
	public String checkIfBucketExist(@PathVariable String bucketName) {
		return awsService.checkIfBucketExist(bucketName);
	}
	...
	public ResponseEntity<String> uploadFiles(@RequestParam(value = "bucketName") String bucketName,
		...
		String response = awsService.uploadFiles(bucketName, filePath, files);
