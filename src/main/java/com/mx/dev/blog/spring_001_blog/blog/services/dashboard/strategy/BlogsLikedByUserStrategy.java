...
@Service
public class BlogsLikedByUserStrategy implements DashboardQueryStrategy {

	private final BlogService blogService;

	public BlogsLikedByUserStrategy(BlogService blogService) {
		this.blogService = blogService;
	}

	@Override
	public Page<?> execute(Long userId, Pageable pageable) throws ServiceException {
		return blogService.dashboardGetBlogsByLikedUserPaginated(userId, pageable);
	}
