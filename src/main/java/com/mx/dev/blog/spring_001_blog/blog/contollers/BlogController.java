...
public class BlogController {
	...
	public ResponseEntity<?> saveBlog(@RequestPart("blogData") BlogCreateRequestDTO blogCreateRequestDTO,
			@RequestPart(value = "blogImage", required = false) MultipartFile blogImage) throws ServiceException {
