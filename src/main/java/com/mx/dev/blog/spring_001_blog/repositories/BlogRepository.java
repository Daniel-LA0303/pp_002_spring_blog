...
public interface BlogRepository extends JpaRepository<BlogEntity, Long> {
	...
	@Query("SELECT new com.mx.dev.blog.spring_001_blog.utils.dtos.blog.BlogEngagementDTO(" + "COALESCE(b.id, 0), "
			...
			+ "LEFT JOIN com.mx.dev.blog.spring_001_blog.entities.comment.CommentEntity c ON b.id = c.blogId "
			+ "LEFT JOIN com.mx.dev.blog.spring_001_blog.entities.blog.BlogUserLikeEntity bult ON b.id = bult.id.blogId "
			+ "LEFT JOIN com.mx.dev.blog.spring_001_blog.entities.blog.BlogUserReadEntity burt ON b.id = burt.id.blogId "
