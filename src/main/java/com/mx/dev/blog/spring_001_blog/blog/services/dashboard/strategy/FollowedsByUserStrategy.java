...
@Service
public class FollowedsByUserStrategy implements DashboardQueryStrategy {

	private final BlogService blogService;

	public FollowedsByUserStrategy(BlogService blogService) {
		this.blogService = blogService;
	}

	@Override
	public Page<?> execute(Long userId, Pageable pageable) throws ServiceException {
		return blogService.dashboardGetFollowedsByUserPaginated(userId, pageable);
	}
