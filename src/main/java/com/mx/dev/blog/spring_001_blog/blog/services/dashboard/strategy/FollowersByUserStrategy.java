...
@Service
public class FollowersByUserStrategy implements DashboardQueryStrategy {

	private final BlogService blogService;

	public FollowersByUserStrategy(BlogService blogService) {
		this.blogService = blogService;
	}

	@Override
	public Page<?> execute(Long userId, Pageable pageable) throws ServiceException {
		return blogService.dashboardGetFollowersByUserPaginated(userId, pageable);
	}
