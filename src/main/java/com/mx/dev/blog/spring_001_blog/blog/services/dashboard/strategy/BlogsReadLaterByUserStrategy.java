...
@Service
public class BlogsReadLaterByUserStrategy implements DashboardQueryStrategy {

	private final BlogService blogService;

	public BlogsReadLaterByUserStrategy(BlogService blogService) {
		this.blogService = blogService;
	}

	@Override
	public Page<?> execute(Long userId, Pageable pageable) throws ServiceException {
		return blogService.dashboardGetBlogsByReadLaterUserPaginated(userId, pageable);
	}
